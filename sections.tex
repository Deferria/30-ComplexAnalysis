    ...
    \subsection{复数代数结构}
        ...
        \begin{dfn}
            ...
            \begin{enumerate}
                ...
                \item 虚部 \(b:\R\); 
            \end{enumerate}
            定义\textbf{虚数单位}为 \((0,1):\C\), 记作 \(\ii\). 设 \(z:\C:=(a,b)\), 记作 \(a+b\ii\). 
        \end{dfn}
        ...
        \begin{dfn}
            ...
            [Dedicatia]
            复数域 \(\C\) 是实数域 \(\R\) 的代数扩张. 这也就是说, 我们将 \(\R[x]\) 的不可约多项式 \(x^2+1\) 的根引入, 这个多项式生成的理想是极大理想, 构造得到的商环 \(\R[x]/\left\langle x^2+1\right\rangle\) 是一个域: 
            \begin{enumerate}
                \item 对加法: 具有封闭性, 满足结合律、交换律, 存在零元, 存在负元; 即 \((\C,+)\) 是 Abel 群; 
                \item 对乘法: 具有封闭性, 满足结合律、交换律, 存在单位元, 存在负元; 即 \((\C\setminus 0,\cdot)\) 是Abel群; 
        ...
        \begin{thm}
            ...
            {复数域的矩阵表示}
            [the Matrix Representation of Complex Number Field]
            [猫猫, Dedicatia]
        ...
        \begin{ppt}
            [Complex-Normed-Vector-Space]
            {复数上的赋范线性空间结构}
            []
            [Dedicatia]
            \((\C, |\cdot|)\) 是赋范线性空间. 更进一步, 是 Banana 空间. 
        \end{ppt}
...
\section{复函数}
    ...
    \subsection{复微分}
        ...
        \begin{dfn}
            ...
            [Dedicatia, 猫猫]
            设 \(D\subseteq\C\), \(D\) 是开集, \(z_0:\C\), \(z_0\in\interior D\), \(f:D\to\C\), 定义 \(f\) 在 \(z_0\) 处\textbf{复可微}, 当且仅当: 
        ...
        \begin{ppt}
            {复导数链式法则}
            [Chain Rule of Complex Derivative]
            [Dedicatia]
        ...
        \begin{crl}
            ...
            []
            [Dedicatia]
            复变量的实值函数的\hyperref[dfn:Complex-Derivative]{导数}或者为0, 或者不存在. 这是因为假如该函数 \(f(z)\) 在 \(z=a\) 处可导, 那么当 \(h\) 以实数值趋近于0时, 
    ...
    \subsection{全纯函数}
        ...
        \begin{dfn}
            ...
            [Holomorphic Function]
            [Dedicatia, 猫猫]
            设 \(D\subseteq\C\), \(D\) 是开集, \(f:D\to\C\), 定义 \(f\) 是 \(D\) 上的\textbf{全纯函数}, 当且仅当: \(\forall z\in D,\) \(f\) 在 \(z\) 处复可微, 记作 \(f\in\Holo[D]\). 
        \end{dfn}

        \begin{ppt}
            [Complex-of-Continuous]
            {全纯函数的实部和虚部是连续实函数}
            []
            [Dedicatia]
        ...
        \begin{prf}
            \Holomorphic{} 适合于Cauchy-Riemann方程. 设复变函数 \(f(z)=u(z)+\ii v(z)\), 那么它在某点 \(z=x+\ii y\) 的导数就可以写成
        ...
        \begin{dfn}
            ...
            容易发现, \Holomorphic{} 的实部 \(u(x,y)\) 和虚部 \(v(x,y)\) \textbf{都是调和函数}. 
        \end{dfn}
        ...
        \begin{thm}
            ...
            []
            [Dedicatia]
            设 \(u(x,y)\) 和 \(v(x,y)\) 具有适合于Cauchy-Riemann方程的一阶连续偏导数, 那么 \(f(z)=u(x+\ii y)+\ii v(x+\ii y)\) 是\Holomorphic{}. 
        \end{thm}
    ...
    \subsection{复函数项级数}
        ...
        \begin{rmk}
            [Dedicatia]
            有关代数基本定理的证明, 目前有很多种方法. 其中有一种是利用复分析的知识来证明. 可以参见定理\ref{thm:FTOA}.
        \end{rmk}
        ...
        \begin{dfn}
            ...
            [Dedicatia]
            称定义在 \(D\) 上的函数列 \(\{f_n\}\) 在 \(D\) 上\textbf{紧致收敛 / 内闭一致收敛}于函数 \(f\), 当且仅当 \(\{f_n\}\) 在 \(D\) 的任意紧致子集 \(K\subseteq D\) 上都\UniformConvergent{} 于函数 \(f\).
        \end{dfn}
        ...
        \begin{crl}
            ...
            [Dedicatia]
            设 \(D\) 上的函数列 \(\{f_n\}\), 则 \(f_n\) 在 \(D\) 上\UniformConvergent{} 当且仅当: 
            \[\forall\varepsilon\in\R^+, \exists N(\varepsilon)\in\N, \forall n_1,n_2>N, |f_{n_1}(x)-f_{n_2}(x)|<\varepsilon\]
            设 \(D\) 上的函数项级数 \(\sum_{n=1}^{\infty} u_n(x)\), 其在 \(D\) 上\UniformConvergent{} 当且仅当: 
        ...
        \begin{thm}
            ...
            在区间 \(D\) 上恒成立, 则级数 \(\sum_{n = 1}^{\infty} u_n(x) \) 在该区间上\UniformConvergent{}. 
        \end{thm}
    ...
    \subsection{解析函数}
        ...
        \begin{thm}
            ...
            \begin{enumerate}
                \item 每一个复数 \(|z|<R\) 都可以使\PowerSeries 绝对收敛. 设 \(0\leqslant\rho <R\), 当 \(|z|\in[0,\rho]\) 时, 级数\UniformConvergent{}; 
        ...
        \begin{dfn}
            ...
            [Analyticity]
            [Dedicatia, 猫猫]
            设 \(D\subseteq\C\), \(D\) 是开集, \(f:D\to\C\), \(z_0:\C\), \(z_0\in\interior D\), 定义 \(f\) 在 \(z_0\) 处\textbf{解析}当且仅当: 
            \[\exists U_0\in B_r(z_0), \exists \{a_n\}:\N\to\C, \forall z\in U_0, f(z)=\sum_{n=0}^{+\infty}a_n(z-z_0)^n\]
        \end{dfn}

        \begin{ppt}
            [Analytic-of-Holomorphic]
            {解析函数必定可导}
            []
            [Dedicatia]
            If $f=\sum\limits_{n=0}^{\infty}a_n(z-z_0)^n$ is \Analytic{} in $B_r:\{z:|z-z_0|<r\}$, then $f'(z)$ exists over $B_r$ and $f'(z_0)=a_1$.
        \end{ppt}
        ...
        \begin{ppt}
            ...
            []
            [猫猫, Dedicatia]
            An \Analytic{}\, function $f$ has \hyperref[dfn:Complex-Derivative]{derivative}s of all orders.
        \end{ppt}
        ...
        \begin{thm}
            ...
            [Taylor Theorem]
            [Dedicatia]
            If $f$ is \Analytic{}\, and equal to a convergent power series on $B_r:\{z:|z-z_0|<r\}$, then the power series is given by:
        ...
        \begin{dfn}
            ...
            [Taylor Series]
            [Dedicatia]
            Given an \Analytic{}\, function $f$ and a neighbourhood $B_r:\{z:|z-z_0|<r\}$, we refer to 
        ...
        \begin{thm}
            ...
            [Dedicatia]
            A Complex-valued function $f\in\Holo[D]$ if and only if $f$ is \Analytic{}\, on $D$.
        \end{thm}

        \begin{prf}
            According to the theorem differentiability if analyticity, if $f$ is \Analytic{}, then $f$ is \Holomorphic{};\\
            ...
            Interchanging the order of summation and integration is justified by uniform convergence in $\zeta\in C$ of the series for $z$ fixed. Thus $f$ has a power series expansion convergent in $B_r$. Hence, $f$ is \Analytic{}\, in $D$.
        \end{prf}
...
\section{作为映照的解析函数}
        ...
        %     []
        %     [Dedicatia]
        %     复数域和定义在其上的复绝对值构成\hyperref[dfn:MetricSpace]{度量空间}. 
        % \end{xmp}
        ...
        % 在复分析中, 我们的所用的拓扑学概念都是由\hyperref[dfn:MetricSpace]{度量空间}诱导产生. 所以它具有很好的性质. 
        ...
        %     [Interior]
        %     [Dedicatia]
        %     集合 \(X\) 的内部是指包含 \(X\) 的最大开集. 记作 \(\interior X\).
        % \end{dfn}
        ...
        %     [Bound]
        %     [Dedicatia]
        %     称集合 \(X\) 的边界是其闭包减去其内部. 一点属于边界, 当且仅当它的邻域同时与 \(X\) 和 \(\lnot X\). 记作 \(\partial X\).  \(\partial X=\cl X\backslash\interior X\).
        % \end{dfn}
        ...
        %     [Topology Subspace]
        %     [Dedicatia]
        %     设 \((X,\tau)\) 是\hyperref[dfn:TopologicalSpace]{拓扑空间},  \(Y\subseteq X\) 是一个子集, 那么可以定义
        %     \[\tau_Y=\{U\cap Y:U\in X\}\]
        %     这时 \((Y,\tau_Y )\) 构成一个\hyperref[dfn:TopologicalSpace]{拓扑空间}, 称为子拓扑空间, 有时也叫相对的拓扑空间. 
        % \end{dfn}
    ...
    %     首先我们可以想象, 一个区间是连通的, 当且仅当它由单一的片组成. 为了更规范地表述, 我们借用点集拓扑的概念:
        ...
        %     []
        %     [Dedicatia]
        %     如果一个\hyperref[dfn:TopologicalSpace]{拓扑空间}是道路连通的, 那么它一定是连通的. 但反之不然. 
        % \end{thm}

        % 然而, 在某些良好性质的\hyperref[dfn:TopologicalSpace]{拓扑空间}中, 道路连通与连通是等价的. 如实数线 \(\R\), 复平面 \(\C\), Euclid空间 \(\R^n\) 等. 
    ...
    % \subsection{区域的紧致性}
        ...
        %     [Dedicatia]
        %     称一个\hyperref[dfn:MetricSpace]{度量空间}是完备的, 当且仅当它的所有Cauchy序列是收敛的（即Cauchy收敛原理恒成立）. 
        % \end{dfn}
        ...
        %     []
        %     [Dedicatia]
        %     一个集合是\hyperref[dfn:Compactness]{紧致的}, 当且仅当它是完备的且全有界的. 
        % \end{thm}
        ...
        %     [Dedicatia]
        %     \(\R\) 和 \(\C\) 的一个子集是\hyperref[dfn:Compactness]{紧致的}, 当且仅当它是闭集且有界的. 
        % \end{xmp}
        ...
        % 这三个概念互相有差异, 但是这是针对一般\hyperref[dfn:TopologicalSpace]{拓扑空间}而言的. 特别地, 我们有: 
        ...
        %     [Dedicatia]
        %     在\hyperref[dfn:MetricSpace]{度量空间}中, \hyperref[dfn:Compactness]{紧致性}、\hyperref[dfn:CountableCompactness]{可数紧性}、序列紧性三者完全等价. 
        % \end{thm}
        ...
        %         \item \textbf{有限覆盖定理(Heine-Borel Theorem)}: 实数集的子集是紧致的当且仅当它是有界闭集. 该公理直接反映了实数系统的\hyperref[dfn:Compactness]{紧致性}. 
        %         \item \textbf{聚点定理(Bolzano-Weierstrass Theorem)}: 实数集中的有界无限子集至少有一个聚点（极限点）. 该公理反映实数系统的\hyperref[dfn:CountableCompactness]{可数紧性}. 
        %         \item \textbf{Cauchy收敛准则(Cauchy's Convergence Criterion)}: 一个实数序列收敛当且仅当它是Cauchy序列（即对于任意 \(\epsilon > 0\), 存在 \(N\) 使得对于所有 \(m, n > N\), 有 \(|a_m - a_n| < \epsilon\). 这条公理反映了实数集是一个完备的\hyperref[dfn:MetricSpace]{度量空间}. 
    ...
    %         []
    %         [Dedicatia]
    %         在连续函数作用下的, \hyperref[dfn:Compactness]{紧致集}的像是紧致集. 
    %     \end{thm}
    ...
    %     \end{thm}
        ...
        %     [Dedicatia]
        %     称\hyperref[dfn:TopologicalSpace]{拓扑空间}上的具有连续逆映射的连续双射为一个\textbf{拓扑映照/同胚映照}, 它保持原拓扑空间的性质, 称为\textbf{拓扑性质}. 同胚的拓扑空间在拓扑性质上是不可区分的. 
        % \end{dfn}
    ...
    \subsection{共形映照}
        ...
        \begin{intrormk}
            [Dedicatia]
            接下来的部分我们将重点研究\Analytic{}{}的几何意义. 也就是说, 将其看作复平面到另一个复平面之间的映射, 它将按某种规律将曲线 \(\gamma\) 映射到曲线 \(\gamma'\), 那么它会表现出极强的约束力. 例如, 它会保持角度不变, 这就是所谓的\textbf{共形性}.
        \end{intrormk}
        ...
        \begin{ppt}
            [Trivial-Analytical-Function]
            {常函数}
            [Constant Function]
            [Dedicatia, 猫猫]
            设 \(\Omega\subseteq\C\), \(f:\Omega\to\C\), \(f\) 在 \(\Omega\) 上\Analytic{}, \(\forall z\in\Omega, f'(z)=0\), 则: 
        ...
        \begin{dfn}
            ...
            [Univalent Analytic Function]
            [Dedicatia]
            定义一个解析函数是\textbf{单叶的}, 当且仅当它在其定义域内是单射. 也就是说, 对于任意 \(z_1,z_2\in\Omega\), 如果 \(f(z_1)=f(z_2)\), 那么 \(z_1=z_2\).
        \end{dfn}
    ...
    \subsection{复平面射影几何}
        ...
        \begin{ppt}
            ...
            []
            [Dedicatia]
            点 \(z\) 和 \(z^*\) 关于过三点 \(z_2,z_3,z_4\) 的圆 \(C\) 对称的充要条件是 \(\XRatio{z^*}{z_2}{z_3}{z_4}=\overline{\XRatio{z}{z_2}{z_3}{z_4}}\).
        \end{ppt}
    ...
    \subsection{初等解析函数}
        ...
        \begin{rmk}
            ...
            \[\cot z=-\ii\frac{\exp \ii z+\exp -\ii z}{\exp \ii z-\exp -\ii z}\]
            \[\sec z=\frac{2}{\exp \ii z+\exp -\ii z}\]
            \[\csc z=\frac{2\ii}{\exp \ii z-\exp -\ii z}\]
        \end{rmk}
        ...
        \begin{dfn}
            ...
            值得注意的是, \textbf{这是一个\hyperref[dfn:Multivalued]{多值函数}! }为了和一般的实对数区别, 我们记作 \(\Ln w\). 这时的每一组值称为一个\textbf{解析分支}. 如果我们取其中的一个分支, 规定 \(\arg w\in[0,2\pi)\), 就可以保证其是单值的, 这时可以使用 \(\ln w\):
            \[\ln w=\ln|w|+\ii\arg w (w\neq 0)\]
        \end{dfn}
        ...
        \begin{dfn}
            ...
            这些都是\hyperref[dfn:Multivalued]{多值函数}. 一般用 \(\operatorname{Arccos}z\),  \(\operatorname{Arcsin}z\) 表示.
        \end{dfn}
        ...
        \begin{ppt}
            [Hyperbolic-Triangular-Relation]
            {双曲函数与三角函数的关系}
            []
            [Dedicatia]
            当变量是纯虚数时, 有: 
        ...
        \begin{dfn}
            ...
            这时, 除非 \(\alpha\) 是正的实整数, 否则幂函数都是\hyperref[dfn:Multivalued]{多值函数}. 
        \end{dfn}
        ...
        \begin{dfn}
            ...
            [Primary Function]
            [Dedicatia]
            称指数函数 \(\exp z\) 和 \(\Ln z\) 通过有限次四则运算和有限次复合运算后得到的函数全体为\textbf{初等函数}. 由于这两个函数本身都是解析的, 所以所有的初等函数都是\Analytic{}. 
        \end{dfn}
        ...
        \begin{dfn}
            ...
            {单值解析分支}
            [Single-valued Analytic Branch]
            设 \(F\) 是区域 \(D\) 上的多值函数, 若存在一个\Analytic{}  \(f\) 使得对任意 \(z\in D\),  \(f(z)\in F(z)\), 就称 \(f\) 是 \(F\) 的一个单值解析分支. 
        \end{dfn}
        ...
        \begin{dfn}
            ...
            [Branch Point]
            [Dedicatia]
            设\(f(z)\)是一个\hyperref[dfn:Multivalued]{多值函数}. 点 \(z = a\) 称为 \(f(z)\) 的一个支点, 如果存在一条围绕 \(a\) 的简单闭合曲线\(C\), 当变量 \(z\) 从某点 \(z_0\) 出发沿 \(C\) 连续变动一周回到 \(z_0\) 时, 函数值 \(f(z)\) 没有回到它的起始值, 而是变成了另一个不同的值. 
        \end{dfn}
    ...
    \subsection{复函数视角下的场论}
        ...
        对于一般的实函数, 我们可以研究其图像. 但是对于复函数, 该怎么画它的图像呢？我们先从\Analytic{} 说起. \\
        例如, 对于函数
        \[w=f(z)=z^2\]
        我们根据实部与虚部拆开, 得到
        \[w=f(x,y)=u(x,y)+\ii v(x,y)=(x+\ii y)^2=(x^2-y^2)+\ii(2xy)\]
        这时自然就会想到, 函数 \(f(z)\) 将 \(z\) 平面的直线 \(x=x_0\) 映射到 \(w\) 平面的曲线 \(u_0(y)=u(x_0,y)=x_0^2-y^2\), 将 \(z\) 平面的直线 \(y=y_0\) 映射到 \(w\) 平面的曲线 \(v_0(x)=v(x,y_0)=2xy_0\). 根据\Analytic{} 的共形性, 这两条曲线在 \(f'(z)\neq 0\) 的地方是正交的. 

        \begin{dfn}
            [Equipotential-Stream-Function]
            {势函数与流函数}
            [Equipotential Function and Stream Function]
            [Dedicatia]
            称\Analytic{}  \(w=f(z)=u(x,y)+\ii v(x,y)\) 对应于一个\textbf{复位势}, 实部 \(u(x,y)\) 称为势函数, 虚部 \(v(x,y)\) 称为流函数. 这个命名来源于场论. 
        \end{dfn}
...
\section{复积分理论}
    ...
    \subsection{复函数的线积分}
        ...
        \begin{ppt}
            [Complex-Integral-Absolute-Value]
            {线积分的绝对值不等式}
            []
            [Dedicatia]
        ...
        \begin{ppt}
            [Conjugate-Integral]
            {共轭线积分}
            [Conjugate Line Integral]
            [Dedicatia]
            考虑关于 \(\bar{z}\) 的线积分, 有如下的关系:
        ...
        \begin{ppt}
            ...
            [Dedicatia]
            与上面的条件一致, 有: 
            \[\int_\gamma f\dd{s}=\int_\gamma f(z)\abs{\dd{z}}=\int_{a}^b f(z(t))\abs{z'(t)}\dd{t}.\]
        \end{ppt}
    ...
    \subsection{Cauchy-Goursat定理}
        ...
        \begin{crl}
            ...
            []
            [Dedicatia]
            连续函数 \(f\) 的积分 \(\int_\gamma f(z)\dd{z}\) 结果不依赖路径的充要条件是:  \(f\) 是定义域 \(D\) 上的\Analytic{} 的导数. 
        \end{crl}
    ...
    \subsection{环绕数与Cauchy 积分公式}
        ...
        \begin{prf}
            ...
            所以该导数等于0, 并且只在有限个点中没有定义, 即 \(\exp h(t)=0\) 时. 显然该函数是连续的, 所以这是一个\hyperref[ppt:Trivial-Analytical-Function]{常解析函数}. 对其应用初值, 即代入 \(t=\alpha\), 可得
    ...
    \subsection{高阶导数与解析函数的性质}
        ...
        \begin{thm}
            ...
            [Morera's Theorem]
            [Dedicatia]
            设 \(f(z)\) 在区域 \(D\) 中有定义且连续, 如果对任意 \(D\) 中的闭曲线 \(\gamma\) 都有 \(\oint_\gamma f(z)\dd{z}=0\), 那么就可以判定 \(f(z)\) 在 \(D\) 上是\Analytic{}.
        \end{thm}
        ...
        \begin{crl}
            ...
            []
            [Dedicatia]
            设 $D\subseteq\C$ 是单连通区域, $f(z)$ 在 $D$ 上\Analytic{}, 那么存在 $F(z):D\to\C$ 使得 $F'=f$.
        \end{crl}
        ...
        \begin{thm}
            ...
            [Liouville's Theorem]
            [Dedicatia]
            在整个平面内都有界的\Analytic{} 必定是\hyperref[ppt:Trivial-Analytical-Function]{常解析函数}. 
        \end{thm}
        ...
        \begin{prf}
            使用反证: 设 \(P(z)\) 是任一次数大于0的多项式, 并假设其恒不等于0. 则 \(\dfrac{1}{P(z)}\) 就是全平面的解析函数. 又因为 \(\lim\limits_{z\to\infty}\dfrac{1}{P(z)}=0\), 所以 \(\dfrac{1}{P(z)}\) 也是一个有界函数. 那么根据\hyperref[thm:Liouville]{Liouville定理}, 它就是常解析函数. 但常函数的次数是0, 矛盾. 
        \end{prf}
        ...
        \begin{thm}
            [Isolated-Zeros]
            {解析函数的零点孤立性定理}
            [Isolated Zeros Theorem of Analytic Functions]
            [Dedicatia]
        ...
        \begin{thm}
            [Unique-Analytic]
            {解析函数的唯一性定理}
            [Unique Analytic Continuation Theorem]
            [Dedicatia]
    ...
    \subsection{Taylor定理与解析函数的奇点}
        ...
        \begin{thm}
            ...
            []
            [Dedicatia]
            设 \(D'\) 是区域 \(D\) 中弃去一点得到的, 有一个\Analytic{}  \(f(z)\) 定义在 \(D'\) 上, 那么存在唯一的定义在 \(D\) 上的解析函数 \(g(z)\), 称为\textbf{延拓函数}, 使之与 \(f(z)\) 在 \(D'\) 上完全重合的充要条件是 \(\lim\limits_{z\to a}(z-a)f(z)=0\).
        \end{thm}
        ...
        \begin{thm}
            ...
            [Taylor's Theorem]
            [Dedicatia]
            设解函数 \(f(z)\) 在包含 \(a\) 点的区域 \(D\) 是\Analytic{}, 那么
        ...
        \begin{ppt}
            [Meromorphic-Function-Equivalent]
            {亚纯函数的等价定义}
        ...
        \begin{crl}
            [Rational-of-Meromorphic]
            {有理函数的亚纯性}
            []
            [Dedicatia]
            有理分式 \(\frac{f(z)}{g(z)}\), 其中 \(g(z)\) 不恒为0, 那么它都是\Meromorphic{}.
        \end{crl}
        ...
        满足第(ii)条件的函数就是\Meromorphic{}. 所以我们可以为极点定义
        ...
        \begin{thm}
            [Weierstrass-Essential-Singularity]
            {本性奇点的 Weierstass 条件}
    ...
    \subsection{同调意义下的Cauchy定理}
        ...
        \begin{thm}
            [Simply-Connected-iff-Winding-Number]
            {单连通的充要条件}
            []
            [Dedicatia]
        ...
        \begin{thm}
            ...
            [Dedicatia]
            如果函数 \(f\) 是一个单连通区域 \(D\) 上的\Analytic{}, 那么对于 \(D\) 内任意一条闭合可求长曲线 \(\gamma\), 都有: 
            \[\oint_{\gamma} f(z) \dd z = 0\]
        ...
        \begin{thm}
            [Cauchy-Integral-Homology]
            {同调意义下的Cauchy 积分定理}
            [Cauchy's Integral Theorem Under Homology]
            [Dedicatia]
            设 \(D\) 是复平面 \(\C\) 中的一个开集, 函数 \(f\) 在 \(D\) 上是\Analytic{}. 那么, 对于 \(D\) 中任何一个闭链 \(\gamma\), 如果 \(\gamma\) 在 \(D\) 中是同调于零的, 则有: 
            \[\oint_{\gamma} f(z) \dd z = 0.\]
        \end{thm}

        同时, \hyperref[dfn:Exact-Differential]{正合微分}的性质可以写为: 

        \begin{ppt}
            {局部正合微分的性质}
            []
            [Dedicatia]
            如果一个微分 \(p\dd{x}+q\dd{y}\) 在 \(D\) 上的每个点的邻域都是\hyperref[dfn:Exact-Differential]{正合微分}, 那么对于 \(D\) 中任意的同调于零的闭链 \(\gamma\), 都有
        ...
        这就是\hyperref[thm:Cauchy-Integral]{Cauchy积分定理}在复分析中成立的根本原因: \Holomorphic{} 的微分在该条件下是正合的. 
        ...
        将\hyperref[thm:Cauchy-Integral]{Cauchy积分定理}用于多连通域, 就得到: 
        ...
        在\hyperref[thm:Cauchy-Integral]{Cauchy 积分公式}的框架下, 同伦和同调从两个不同的角度——连续变形和边界关系出发, 得出了相同的强大结论: 解析函数在“没有包围奇点”的闭曲线上的积分为零. 它们共同构成了我们理解复分析乃至整个现代数学中“全局”与“局部”关系的基石. 同伦更几何直观, 而同调更代数强大, 两者相辅相成. 
    ...
    \subsection{留数定理}
        ...
        \begin{prf}
            我们回忆曾经的 Cauchy 积分公式: 
            \[\Windn(\gamma,a)f(a)=\frac{1}{2\pi\ii}\int_\gamma\frac{f(z)}{z-a}\dd{z}\]
            要求 \(\gamma\) 在 \(D\) 上\hyperref[dfn:Null-Homologous]{同调于零}且 \(f(z)\) 是\Analytic{}. 设 \(a_j\) 的去心邻域 \(0<|z-a_j|<\delta_j\) 上的闭圆环 \(C_j\) 半径小于 \(\delta_j\), 记
        ...
        \begin{crl}
            ...
            \[\Windn(\gamma,a)f(a)=\frac{1}{2\pi\ii}\int_\gamma\frac{f(z)}{z-a}\dd{z} \]
            这是因为函数 \(\frac{f(z)}{z-a}\) 在 \(z=a\) 处有一个单极点, 那么在该处的留数就是 \(f(a)\), 环绕数是1, 得到这个公式. Cauchy 积分公式可以看作留数定理的特例.
        \end{crl}
    ...
    如果奇点出现在了积分区域的边界, 那么留数定理就要也随之推广: 
        ...
        如果积分路径 \(C\) 包含了实的极点, 便不再符合 Cauchy 积分公式发适用条件, 这时需要用小圆弧绕过极点: 
        ...
        \begin{xmp}
            ...
            可知, 只有当 \(y\leq 0\),  \(x=n\pi\) 时是实数, 这时对顶点 \(0, \pi, \pi+\ii Y, \ii Y\) 的矩形使用Cauchy 积分定理, 使用小圆弧绕行避开 \(0, \pi\) 两点. \bysorry
        \end{xmp}
    ...
    \subsection{局部映射与幅角原理}
        ...
        \begin{thm}
            [Winding-Number-Zeros]
            {零点的环绕数定理}
            []
            [Dedicatia]
            设函数 \(f(z)\) 是开圆盘 \(D\) 上的\Analytic{} 且不恒等于 0,  \(z_i\) 是 \(f(z)\) 的零点, 各个零点按照阶数重复计算, 那么对于 \(D\) 上每一条不通过零点的闭曲线 \(\gamma\), 都有
            \[\sum_{i=1}^n \Windn(\gamma, z_i)=\frac{1}{2\pi\ii}\oint_\gamma\frac{f'(z)}{f(z)}\dd{z} \] 
            这里的求和只有有限项不为 0.
        \end{thm}

        \begin{prf}
            对函数 \(f(z)\) 反复使用\Taylor{}, 得到
        ...
        \begin{crl}
            ...
            [Argument Principle]
            [Dedicatia]
            设 \(f(z)\) 是 \(D\) 上的\Meromorphic{}, 具有 \(m\) 个零点 \(a_j\) 和 \(n\) 个极点 \(b_k\),  \(\gamma\) 是 \(D\) 上的\hyperref[dfn:Null-Homologous]{同调于零}的不过 \(a_j\) 与 \(b_k\) 的闭链, 有
        ...
        \begin{crl}
            [Argument-Principle-Parameterized]
            {参数化的辐角原理}
            []
            [Dedicatia]
            设 \(f(z)\) 是 \(D\) 上的\Meromorphic{}, 具有 \(m\) 个零点 \(a_j\) 和 \(n\) 个极点 \(b_k\),  \(\gamma\) 是 \(D\) 上的\hyperref[dfn:Null-Homologous]{同调于零}的不过 \(a_j\) 与 \(b_k\) 的闭链,  \(g(z)\) 是定义在 \(D\) 上的\Analytic{}, 有
        ...
        \begin{thm}
            ...
            [Rouch\'e Theorem]
            [Dedicatia]
            设 \(f(z)\) 与 \(g(z)\) 在区域 \(D\) 上解析,  \(\gamma\) 是 \(D\) 上的\hyperref[dfn:Null-Homologous]{同调于零}的闭链, 如果在 \(\gamma\) 上有
            \[|g(z)|<|f(z)|\]
    ...
    \subsection{调和函数与Poisson积分}
        ...
        从某种意义上讲, 复分析实际上就是一对共轭调和函数在 \(\R^2\) 上的分析. 
...
\section{函数的级数展开与因子分解}
    ...
    \subsection{Weierstrass定理}
        ...
        \begin{thm}
            ...
            \begin{enumerate}
                \item 每一个复数 \(|z|<R\) 都可以使幂级数绝对收敛. 设 \(0\leqslant\rho <R\), 当 \(|z|\in[0,\rho]\) 时, 级数\UniformConvergent{}; 
                \item 当 \(|z|>R\) 时幂级数发散; 
                \item \textbf{当 \(|z|<R\) 时的和是\Analytic{} }, 根据一致收敛性, 其导数可以逐项微分求得. 
            \end{enumerate}
            这个 \(R\) 由公式
            \[\frac{1}{R}=\lim_{n\to \infty}\sup\sqrt[n]{|a_n|}\]
            确定. \\
        ...
        \begin{thm}
            [Uniform-Convergence-of-Analyticity]
            {一致收敛保持解析性}
            [Uniform Convergence Preserves Analyticity]
            [Dedicatia]
            设 \(f_n\) 是定义在一簇开集 \(D_n\) 上的\Analytic{}, 函数列 \(\{f_n\}\) 在 \(D\) 上收敛于函数 \(f(z)\), 且在 \(D\) 的任意紧致子集上\UniformConvergent{} 于函数 \(f(z)\), 那么 \(f(z)\) 是解析函数, 并且 \(f'_n(z)\) 在 \(D\) 的任一紧致子集上都一致收敛于 \(f'(z)\).
        \end{thm}
        ...
        \begin{thm}
            ...
            设级数 \(\sum_{n = 1}^{\infty} u_n(z)\) 的每一项都是\Analytic{}, 且在 \(D\) 的任意紧致子集 \(D'\) 上\UniformConvergent{}, 那么级数的和函数 \(S(z)\) 在 \(D\) 上是\Analytic{}, 且可以逐项微分. 
        ...
        \begin{thm}
            ...
            [Hurwitz's Theorem]
            [Dedicatia]
            设函数 \(f_n(z)\) 在 \(D\) 上解析, 并设 \(f_n(x)\) 在 \(D\) 的任意紧致子集上\UniformConvergent{} 于 \(f(x)\), 那么 \(f(z)\) 在 \(D\) 上或者恒为常数, 或者是解析单射.
        \end{thm}
    ...
    \subsection{Taylor 级数与 Laurent 级数}
        ...
        \begin{thm}
            ...
            [Laurent's Series]
            [Dedicatia, 猫猫]
            设 \(R_1\geq 0, R_2\leq+\infty\), \(f:\{z|R_1<|z-z_0|<R_2\}\to\C\), \(f\) \Analytic{}, 则 \(f\) 可以写成同时包含正幂和负幂的级数: 
        ...
        \begin{prf}
            ...
            对于圆环内的一点  \(z\), 由\hyperref[thm:Combined-Closed-Circuit]{复合闭路定理}可得: 
        ...
        \begin{rmk}
            [Dedicatia]
            这时, \hyperref[thm:Taylor]{Taylor 级数}是 Laurent 级数在: \(f(z)\) 在 \(z_0\) 处解析的条件下的特例: 这时就将 Laurent 级数中的圆环就是一个圆盘. 作出 Laurent 级数, 根据系数 \(a_n\) 的计算公式和\hyperref[thm:Cauchy-Integral]{Cauchy积分定理}, 所有的负数幂系数都等于0. 这时的Laurent级数就变成了Taylor级数. 只要在非奇点处附近展开就会得到Taylor级数. \\
        ...
        \begin{xmp}
            ...
            计算函数
            \[f(z)=\frac{1}{z(z-2)^3}\]
            在 \(z=2\) 处的 Laurent 级数系数 \(a_{-1},a_{0},a_{1}\).\\
        ...
        \begin{thm}
            {解析函数的孤立奇点与 Laurent 级数的关系}
            设 \(z_0\) 是在其邻域内解析的函数 \(f\) 的一个奇点. 那么
            \begin{itemize}
                \item 如果 \(z_0\) 是\hyperref[dfn:Removable-Singularity]{可去奇点}, 那么在 \(z_0\) 处的 \(f\) 的 Laurent 级数中不含负数次幂; 
                \item 如果 \(z_0\) 是\hyperref[dfn:Pole]{极点}, 那么在 \(z_0\) 处的 \(f\) 的 Laurent 级数中只含有有限多项负数次幂; 
                \item 如果 \(z_0\) 是\hyperref[dfn:Essential-Singularity]{本性奇点}, 那么在 \(z_0\) 处的 \(f\) 的 Laurent 级数中有无限多项负数次幂. 
            \end{itemize}
        \end{thm}
        ...
        \begin{cxmp}
            ...
            []
            [Dedicatia]
            \hyperref[thm:Morera]{Morera 定理}中对函数连续性的要求不能省略.\\
            设函数
        ...
        \begin{crl}
            ...
            \(\varphi(z)\) 在 \(z_0\) 处解析且不为0. 这时根据\hyperref[thm:Laurent-Series]{Laurent级数}的负一次幂项系数等于 \(\varphi(z)\) 的\hyperref[thm:Taylor]{Taylor 级数}的 \(m-1\) 次幂项系数, 可得
    ...
    \subsection{亚纯函数的部分分式展开}
        ...
        我们从\hyperref[thm:Laurent-Series]{Laurent 级数}中可以看到: 如果 \(f(z)\) 是一个\Meromorphic{}, 对极点 \(b_n\), 就会有 \(f(z)\) 的非解析部分 \(P_n\qty(\frac{1}{z-b_n})\). 如此减去所有的非解析部分之后就会得到解析的函数 \(g(z)\). 也就是说我们可以将 \(f(z)\) 分解为
        \[f(z)=\sum_{i=1}^{n}P_n\qty(\frac{1}{z-b_n})+g(z)\]
        但是这样定义,  \(P_n\) 往往是无限项, 还有可能不收敛. 所以我们改进: 

        \begin{thm}
            {亚纯函数的部分分解定理}
            设 \(\{b_n\}\) 是一个复数序列,  \(\lim_{n\to\infty }b_n=\infty\), 设 \(P_n\) 是不含常数项的多项式, 那么存在一些在全平面的\Meromorphic{} \(f(z)\), 其以 \(b_n\) 为\hyperref[dfn:Pole]{极点}, 非解析部分为所有的 \(P_n\qty(\frac{1}{z-b_n})\), 使得
            \[f(z)=\sum_{i=1}^{n}\pqty{P_n\pqty{\frac{1}{z-b_n}}-p_n(z)}+g(z)\]
            这里 \(p_n(z)\) 是有限项数的多项式,  \(g(z)\) 是全平面的\Analytic{}. 
        \end{thm}

        \begin{prf}
            我们可以假设 \(b_n\) 没有一个为0. 那么就可以在 \(z=0\) 处写出Taylor级数, 取部分和 \(S_k\) 为 \(p_n(z)\), 那么差值 \(|P_n-p_n|\) 可以用\Taylor{} 显式估计. \\
            \continued
        \end{prf}
        ...
        \begin{xmp}
            ...
            当 \(y\to\infty\) 时, 可以发现 \(|\sin^2\pi z|\to\infty\),  \(\frac{\pi^2}{\sin^2\pi z}\rightrightarrows 0\). 而上面已经知道在任意紧致集上 \(\sum_{n=-\infty}^{+\infty}\frac{1}{(z-n)^2}\rightrightarrows 0\), 这就说明了 \(|g(z)|\) 在全平面上有界且极限为0. 根据\hyperref[thm:Liouville]{Liouville定理},  \(g(z)=0\). 这便得到等式: 
            \[\frac{\pi^2}{\sin^2\pi z}=\sum_{n=-\infty}^{+\infty}\frac{1}{(z-n)^2}.\]
            将两边同时取微分. 由于\UniformConvergent{}, 所以逐项微分是合法的: 
        ...
        \begin{dfn}
            ...
            整函数有以下三类: 
            \begin{enumerate}
                \item \hyperref[ppt:Trivial-Analytical-Function]{常解析函数}; 
                \item 有理函数, 即多项式; 
        ...
        \begin{ppt}
            ...
            上述三类整函数有如下的性质:
            \begin{enumerate}
                \item 整函数是常解析函数当且仅当无穷远点是它的\hyperref[dfn:Removable-Singularity]{可去奇点};
                \item 整函数是有理函数当且仅当无穷远点是它的\hyperref[dfn:Pole]{极点};
    ...
    \subsection{无穷乘积与典范乘积}
        ...
        \begin{prf}
            ...
            这里的对数取使得 \(\Im r_n(z)\in[-\pi,\pi)\) 的单值解析分支. 在 \(|z|\leqslant R\) 时, 在原点处作\hyperref[thm:Taylor]{Taylor 级数}:
        ...
        \begin{ppt}
            [Gamma-Logarithmic-Derivative-Formula]
            {对数导数公式}
    ...
    \subsection{正规族}
        ...
        \begin{thm}
            [Weierstrass-2]
            {紧致收敛度量的 Weierstrass 定理}
            []
            [Dedicatia]
            如果解析函数列 \(\{f_n\}\) 在 \(D\) 上紧致收敛, 那么其极限函数 \(f\) 也\Analytic{}.
        \end{thm}
        ...
        \begin{thm}
            ...
            []
            [Dedicatia]
            一个复函数族 \(\mathcal{F}\) 是\hyperref[dfn:Normal-Family]{正规族}, 当且仅当其在装备了紧致收敛度量的解析函数空间中是相对紧致集.
        \end{thm}
        ...
        \begin{thm}
            ...
            []
            [Dedicatia]
            函数族 \(\mathcal{F}\) 在区域 \(D\) 是\hyperref[dfn:Normal-Family]{正规族}当且仅当:
            \begin{enumerate}
...
\section{Riemann映照定理}
    ...
    \subsection{多边形的共形映射}
        ...
        \begin{dfn}
            ...
            [Conformal Modulus]
            [Dedicatia]
            设单连通区域 \(D\) 通过 Schwarz-Christoffel 变换映到了矩形区域 \([0,1]\times[0,m]\), 那么称 \(m\) 为区域 \(D\) 的\textbf{共形模量}.\\
            其中:
            \[m=\frac{K'(k)}{K(k)}.\]
        \end{dfn}
    ...
    \subsection{反射原理}
        ...
        \begin{thm}
            [Meromorphic-Schwarz-Reflection]
            {亚纯反射原理}
            []
            [Dedicatia]
            设区域 \(D\) 被一条实轴上的直线 \(L\) 分成两部分 \(D^+\) 和 \(D^-\), 且 \(D^-\) 是 \(D^+\) 关于 \(L\) 的镜像. 如果函数 \(f\) 在 \(D^+\) 上是\Meromorphic{} 且在 \(L\) 上取实值, 那么可以定义函数 \(\tilde{f}\) 在整个区域 \(D\) 也是\Meromorphic{}, 其定义为
            \[\tilde{f}(z)=\begin{cases}
                f(z), & z\in D^+\\
                \overline{f(\bar{z})}, & z\in D^-
            \end{cases}\]
...
\section{椭圆函数}
    ...
    \subsection{椭圆函数的引入}
        ...
        \begin{dfn}
            ...
            [Elliptic Function]
            [Dedicatia]
            定义复函数 \(f\) 是椭圆函数, 当且仅当 \(f\) 是双周期函数且在基本周期区域内是\Meromorphic{}.
        \end{dfn}

        \begin{dfn}
            [Elliptic-Function-Order]
            {椭圆函数的阶}
            [Order]
            [Dedicatia]
        ...
        \begin{ppt}
            ...
            []
            [Dedicatia]
            设 \(f\) 是椭圆函数, 那么 \(f\) 的阶数至少为 2. 不存在阶数为 1 的椭圆函数.
        \end{ppt}
...
\section{Riemann曲面}
    ...
    \subsection{解析延拓}
        ...
        \begin{crl}
            [Analytic-Continuation-Power-Series-Criterion]
            {解析延拓的幂级数判别法}
            [Power Series Criterion for Analytic Continuation]
            [Dedicatia]
